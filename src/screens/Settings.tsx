...
const agreements = {
  privacy: {
    ...
    sections: [
      ...
      ["照片与分身", "相册展示的是预置示例图片，拍照为模拟取景。本原型不会读取设备相册、调用摄像头或上传你的真实照片。"],
      ["数据保存", "选中的示例照片、分身和作品仅保存在当前页面的运行状态中。刷新或关闭页面后会清空，作品可在详情页删除。"],
